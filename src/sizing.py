#!/usr/bin/env python
"""
UR3 actuator sizing and model generation for MuJoCo.

This module contains:
  - dataclasses for motors (HarmonicDrive, MotorShell),
  - XML helpers (load/save, find joints, inertials),
  - inertia update with parallel axis theorem,
  - UR3ModelGenerator: high-level API to build MJCF variants.

Concrete motor data are defined in main.py.
"""
